...
void Cars()
{
	...
	glColor3ub(1,1,1);
	glVertex2f(x, y);
	for(int i = 0; i <= tAmount; i++) { glVertex2f((x + radius * cos(i*tPi/tAmount)), (y + radius * sin(i*tPi/tAmount)));}
...
void Clouds()
{
	...
	GLfloat x9=-0.56180627660301f; GLfloat y9=0.78658191641501f; GLfloat radius9 =.04f; ///-5.6180627660301, 7.8658191641501
	...
	GLfloat x10=-0.49770130333574f; GLfloat y10=0.78269676652002f; GLfloat radius10 =.05f; ///-4.7633297891332, 7.6521359199258
	...
	GLfloat x11=-0.53712705281067f; GLfloat y11=0.81249084041737f; GLfloat radius11 =.025f;
	...
	GLfloat x12=-0.43359633006847f; GLfloat y12=0.79823736609996f; GLfloat radius12 =.04f;
	...
	GLfloat x13=-0.47050525407084f; GLfloat y13=0.81600766588994f; GLfloat radius13 =.04f;
	...
	GLfloat x14=0.56180627660301f; GLfloat y14=0.78658191641501f; GLfloat radius14 =.04f; ///-5.6180627660301, 7.8658191641501
	...
	GLfloat x15=0.49770130333574f; GLfloat y15=0.78269676652002f; GLfloat radius15 =.05f; ///-4.7633297891332, 7.6521359199258
	...
	GLfloat x16=0.53712705281067f; GLfloat y16=0.81049084041737f; GLfloat radius16 =.025f;
	...
	GLfloat x17=0.43359633006847f; GLfloat y17=0.79823736609996f; GLfloat radius17 =.04f;
	...
	GLfloat x18=0.47050525407084f; GLfloat y18=0.81600766588994f; GLfloat radius18 =.04f;
...
void Flag()
{
	...
	GLfloat x20=0.05352660188788f; GLfloat y20=0.23248004308144f; GLfloat radius20 =.03f;
